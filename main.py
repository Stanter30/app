...
dx_obj = 50  # длина по X
dy_obj = 50 # длина по Y
dz_obj = 50  # длина по Z
...
tic = time.perf_counter()
dT = dT_Eff_M(Tnorm, xyHh[:, :3], xyHh[:, 3], xyzMod, dxyz, Kappa, Q, Dr, Ir, len_calc, max_len_calc, shape_cube, X, Y, Z)
toc = time.perf_counter()
